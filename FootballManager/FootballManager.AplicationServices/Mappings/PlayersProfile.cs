    ...
    public class PlayersProfile : Profile
    {
        public PlayersProfile()
        {
            this.CreateMap<AddNewPlayerRequest, Player>()
                ...
                .ForMember(x => x.Position, y => y.MapFrom(z => PlayerPositionMapper.FromShort(z.Position)))
            ...
            this.CreateMap<Player, PlayerDTO>()
                ...
                .ForMember(x => x.FirstName, y => y.MapFrom(z => z.FirstName))
                .ForMember(x => x.Position, y => y.MapFrom(z => PlayerPositionMapper.ToShort(z.Position)))
